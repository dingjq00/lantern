...
- 系统覆盖：EAM（设备资产）、EDHR（检测流程）、MES（制造执行）及通用术语查询。
- 验证设施：EAM/EDHR benchmark、平台级路由与跨系统 benchmark、质量评估页面。

截至 `2026-05-27`，代码中注册了 30 个 YAML skills：EAM 12 个、EDHR 7 个、MES 10 个、common 1 个。短期开发状态和待处理风险见 [docs/handoff.md](docs/handoff.md)。
...
| `mcp-server/` | EAM / EDHR / MES 业务 API handler |
