  ...
  return (
    <div className="flex gap-3 p-4 border-t border-gray-200 bg-white">
      <input
        ...
        disabled={disabled}
        className="flex-1 px-4 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent disabled:opacity-50 text-sm text-gray-900 placeholder:text-gray-400"
      />
      <button
